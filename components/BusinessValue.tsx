...
const cardValues: cardProps[] = [
  {
    hText: "Strategic Direction:",
    pText:
      "Gain clarity on your brand voice, messaging, and audience engagement approach.",
  },
  {
    hText: "Stronger Brand Presence:",
    pText:
      "Build trust and recognition with consistent, high quality communication",
  },
  {
    hText: "Time Back for What Matters:",
    pText:
      "Free up internal resources while we handle your content and communication needs with precision",
  },
  {
    hText: "Creative Expertise on Demand:",
    pText:
      "Access a skilled team that thinks with you, not just for you. Bringing fresh ideas to the table.",
  },
];
